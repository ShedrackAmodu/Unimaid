...
urlpatterns = [
    ...
    # E-Library Session Management
    path("elibrary/checkin/", views.elibrary_checkin, name="elibrary_checkin"),
    path("elibrary/checkout/", views.elibrary_checkout, name="elibrary_checkout"),
    path("elibrary/dashboard/", views.elibrary_dashboard, name="elibrary_dashboard"),
    path("elibrary/reports/", views.elibrary_reports, name="elibrary_reports"),
    path("elibrary/session/<int:session_id>/", views.elibrary_session_detail, name="elibrary_session_detail"),
]
